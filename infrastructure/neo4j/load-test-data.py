...
Usage:
    python load-test-data.py [--input events.json] [--batch-size 100]
    python load-test-data.py --input test-events.json --batch-size 500
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default="naglfar123",
        help="Neo4j password (default: naglfar123)"
    )
